...
export const DOCTRINE_TOPICS: DoctrineTopic[] = [
  {
    ...
    letter:
      "Nuestra visión de la identidad de Dios\n\nLa Biblia nos revela, desde Génesis hasta Apocalipsis, la relación de Dios con el ser humano. Nuestro propósito no es comenzar desde una doctrina trinitaria o unicista, sino observar cómo Dios se da a conocer progresivamente a través de las Escrituras.\n\nDios con el hombre. Desde el principio, Dios se relacionó con la humanidad. Habló con los hombres, se manifestó de diferentes maneras y comunicó su voluntad por medio de sus profetas. «Dios, habiendo hablado muchas veces y de muchas maneras en otro tiempo a los padres por los profetas…» (Hebreos 1:1).\n\nDios entre los hombres. La revelación alcanza su punto culminante en Jesucristo. Isaías anunció a Emanuel, «Dios con nosotros» (Isaías 7:14; Mateo 1:23). Un niño nos es nacido, y se llamará su nombre Admirable, Consejero, Dios Fuerte, Padre Eterno, Príncipe de Paz (Isaías 9:6). El Verbo fue hecho carne y habitó entre nosotros (Juan 1:14). Él es la imagen del Dios invisible (Colosenses 1:15), y en él habita corporalmente toda la plenitud de la Deidad (Colosenses 2:9). Esto se entiende dentro del monoteísmo absoluto: «Yo soy Jehová, y ninguno más hay; no hay Dios fuera de mí» (Isaías 45:5). Buscamos comprender quién es Jesús dentro de la identidad del único Dios, sin convertirlo en un segundo Dios ni ignorar los textos que distinguen al Padre y al Hijo.\n\nDios en el hombre. Jesús prometió acerca del Espíritu: «Mora con vosotros, y estará en vosotros» (Juan 14:17). Somos templo de Dios, y el Espíritu de Dios mora en nosotros (1 Corintios 3:16). Romanos 8 habla del Espíritu de Dios, del Espíritu de Cristo y de Cristo en nosotros, hasta que Cristo sea formado en vosotros (Gálatas 4:19).\n\nUn solo Dios que se revela, se acerca al ser humano en Jesucristo y habita en sus hijos por su Espíritu. No imponemos una etiqueta doctrinal. Nuestro centro es Jesucristo. La Escritura será nuestra base, Cristo nuestro centro y la búsqueda de la verdad nuestro compromiso.",
    sides: [
      {
        name: "Nuestra visión",
        mine: true,
...
const DOCTRINE_EN: Record<string, Pick<DoctrineTopic, "title" | "who" | "issue" | "letter" | "sides">> = {
  identidad: {
    ...
    letter:
      "Our vision of the identity of God\n\nThe Bible reveals, from Genesis to Revelation, God’s relationship with man. Our purpose is not to begin from a trinitarian or oneness doctrine, but to watch how God makes Himself known through the Scriptures.\n\nGod with man. From the beginning God spoke with men, manifested Himself, and made His will known by the prophets (Hebrews 1:1).\n\nGod among men. The revelation reaches its height in Jesus Christ: Emmanuel, God with us (Isaiah 7:14; Matthew 1:23). A child is born, Mighty God, Everlasting Father (Isaiah 9:6). The Word was made flesh and dwelt among us (John 1:14). He is the image of the invisible God (Colossians 1:15), and in Him dwells all the fullness of the Godhead bodily (Colossians 2:9). This is held within absolute monotheism: I am the LORD, and there is none else (Isaiah 45:5). We seek to understand who Jesus is within the identity of the one God, without making Him a second God, and without ignoring the texts that distinguish the Father and the Son.\n\nGod in man. Jesus promised concerning the Spirit: He dwells with you, and shall be in you (John 14:17). You are the temple of God (1 Corinthians 3:16). Romans 8 speaks of the Spirit of God, the Spirit of Christ, and Christ in you, until Christ be formed in you (Galatians 4:19).\n\nOne God who reveals Himself, comes near in Jesus Christ, and dwells in His children by His Spirit. We do not impose a doctrinal label. Our center is Jesus Christ. Scripture is our basis, Christ our center, and the search for truth our commitment.",
    sides: [
      {
        name: "Our vision",
        mine: true,
