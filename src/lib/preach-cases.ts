...
export const PREACH_CASES: PreachCase[] = [
  ...
  },
  {
    ...
    who: "Quien sigue a la Watchtower: niega que Jesús es Dios y lee una Biblia traducida por su propia organización.",
    issue: "La sinceridad no convierte una doctrina en verdad. Examinadlo todo; retened lo bueno.",
    approach:
      "Con respeto, no para pelear. Compara el griego, la Reina-Valera y la Traducción del Nuevo Mundo, y pregunta: ¿la doctrina se ajusta a la Escritura, o se ajusta la traducción a la doctrina?",
    points: [
      "La Traducción del Nuevo Mundo añade «demás» en Colosenses 1:16, pone «Jehová» donde el griego dice «Señor» en Romanos 10:13 y dice «un dios» en Juan 1:1.",
      "Hebreos 1:8, Tito 2:13, 2 Pedro 1:1 y Hechos 20:28 llaman al Hijo Dios y Salvador; la TNM los separa o los cambia.",
      "La Santa Cena es para todos los creyentes: «Bebed de ella todos». No solo para 144,000.",
      "Cristo resucitó con el mismo cuerpo: «Palpad, y ved; un espíritu no tiene carne ni huesos».",
      "El arrebatamiento es para todos: los muertos en Cristo resucitan y los que vivimos somos arrebatados con ellos.",
      "Cristo reina desde su resurrección. La fecha 1914 no está escrita en la Biblia.",
    ],
    verseIds: ["jn-1-1", "ro-10-13", "col-2-9", "mt-26-26", "1co-11-28", "1ts-4-16", "1co-15-51", "hch-4-12"],
...
> = {
  ...
  testigos: {
    ...
    who: "A follower of the Watchtower: denies that Jesus is God and reads a Bible translated by their own organization.",
    issue: "Sincerity does not turn a doctrine into truth. Test all things; hold fast what is good.",
    approach:
      "With respect, not to fight. Compare the Greek, the New King James Version and the New World Translation, and ask: does the doctrine conform to Scripture, or is the translation made to conform to the doctrine?",
    points: [
      "The New World Translation adds «other» in Colossians 1:16, puts «Jehovah» where the Greek says «Lord» in Romans 10:13 and says «a god» in John 1:1.",
      "Hebrews 1:8, Titus 2:13, 2 Peter 1:1 and Acts 20:28 call the Son God and Savior; the NWT separates or changes them.",
      "The Lord’s Supper is for every believer: «Drink from it, all of you». Not only for 144,000.",
      "Christ rose with the same body: «Handle Me and see, for a spirit does not have flesh and bones».",
      "The rapture is for all: the dead in Christ rise and we who are alive are caught up with them.",
      "Christ has reigned since His resurrection. The date 1914 is not written in the Bible.",
    ],
