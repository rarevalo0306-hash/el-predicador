...
// .grok/ is sandbox state, not repo content (see .gitignore), so the skill docs
// are absent in a clone. Check whichever of these documents this workspace has;
// AGENTS.md is versioned and always carries its half of each rule.
...
test(
  ...
  { skip: !hasDoc(OG_SKILL) && `${OG_SKILL} is sandbox state, absent in this workspace` },
  () => {
